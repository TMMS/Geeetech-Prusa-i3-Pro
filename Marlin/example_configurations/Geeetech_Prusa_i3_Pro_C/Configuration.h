...
#define STRING_CONFIG_H_AUTHOR "(Tiago Miguel Martins Silva, Prusa i3 Pro C)" // Who made the changes.
...
#define HOTEND_OFFSET_X {0.0, 32.0} // (in mm) for each extruder, offset of the hotend on the X axis
...
#define EXTRUDE_MAXLENGTH ((X_MAX_POS - X_MIN_POS)+(Y_MAX_POS - Y_MIN_POS)) //prevent extrusion of very large distances.
